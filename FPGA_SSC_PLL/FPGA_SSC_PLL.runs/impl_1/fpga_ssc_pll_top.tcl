...
OPTRACE "link_design" START { }
  link_design -top fpga_ssc_pll_top -part xcvu9p-flga2104-2L-e 
...
OPTRACE "opt_design reports" START { REPORT }
  ...
  generate_parallel_reports -reports { "report_drc -file fpga_ssc_pll_top_drc_opted.rpt -pb fpga_ssc_pll_top_drc_opted.pb -rpx fpga_ssc_pll_top_drc_opted.rpx"  }
  set_param project.isImplRun false
OPTRACE "opt_design reports" END { }
OPTRACE "Opt Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force fpga_ssc_pll_top_opt.dcp
...
OPTRACE "place_design reports" START { REPORT }
  set_param project.isImplRun true
  generate_parallel_reports -reports { "report_io -file fpga_ssc_pll_top_io_placed.rpt" "report_utilization -file fpga_ssc_pll_top_utilization_placed.rpt -pb fpga_ssc_pll_top_utilization_placed.pb" "report_control_sets -verbose -file fpga_ssc_pll_top_control_sets_placed.rpt"  }
  set_param project.isImplRun false
OPTRACE "place_design reports" END { }
OPTRACE "Place Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force fpga_ssc_pll_top_placed.dcp
...
OPTRACE "Post-Place Phys Opt Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force fpga_ssc_pll_top_physopt.dcp
...
OPTRACE "route_design reports" START { REPORT }
  set_param project.isImplRun true
  generate_parallel_reports -reports { "report_drc -file fpga_ssc_pll_top_drc_routed.rpt -pb fpga_ssc_pll_top_drc_routed.pb -rpx fpga_ssc_pll_top_drc_routed.rpx" "report_methodology -file fpga_ssc_pll_top_methodology_drc_routed.rpt -pb fpga_ssc_pll_top_methodology_drc_routed.pb -rpx fpga_ssc_pll_top_methodology_drc_routed.rpx" "report_power -file fpga_ssc_pll_top_power_routed.rpt -pb fpga_ssc_pll_top_power_summary_routed.pb -rpx fpga_ssc_pll_top_power_routed.rpx" "report_route_status -file fpga_ssc_pll_top_route_status.rpt -pb fpga_ssc_pll_top_route_status.pb" "report_timing_summary -max_paths 10 -report_unconstrained -file fpga_ssc_pll_top_timing_summary_routed.rpt -pb fpga_ssc_pll_top_timing_summary_routed.pb -rpx fpga_ssc_pll_top_timing_summary_routed.rpx -warn_on_violation " "report_incremental_reuse -file fpga_ssc_pll_top_incremental_reuse_routed.rpt" "report_clock_utilization -file fpga_ssc_pll_top_clock_utilization_routed.rpt" "report_bus_skew -warn_on_violation -file fpga_ssc_pll_top_bus_skew_routed.rpt -pb fpga_ssc_pll_top_bus_skew_routed.pb -rpx fpga_ssc_pll_top_bus_skew_routed.rpx"  }
  set_param project.isImplRun false
OPTRACE "route_design reports" END { }
OPTRACE "Route Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force fpga_ssc_pll_top_routed.dcp
...
OPTRACE "route_design write_checkpoint" END { }
  write_checkpoint -force fpga_ssc_pll_top_routed_error.dcp
...
OPTRACE "read constraints: write_bitstream" END { }
  set_property XPM_LIBRARIES {XPM_CDC XPM_MEMORY} [current_project]
  catch { write_mem_info -force -no_partial_mmi fpga_ssc_pll_top.mmi }
OPTRACE "write_bitstream setup" END { }
OPTRACE "write_bitstream" START { }
  write_bitstream -force fpga_ssc_pll_top.bit 
OPTRACE "write_bitstream" END { }
OPTRACE "write_bitstream misc" START { }
OPTRACE "read constraints: write_bitstream_post" START { }
OPTRACE "read constraints: write_bitstream_post" END { }
  catch {write_debug_probes -quiet -force fpga_ssc_pll_top}
  catch {file copy -force fpga_ssc_pll_top.ltx debug_nets.ltx}
