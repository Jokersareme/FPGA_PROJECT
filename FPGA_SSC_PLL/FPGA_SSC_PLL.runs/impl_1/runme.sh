...
HD_PWD='C:/Users/admin/Desktop/cygao/20260720/fpga_pll_mash111_dtc_ssc/FPGA_SSC_PLL/FPGA_SSC_PLL.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fpga_ssc_pll_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fpga_ssc_pll_top.tcl -notrace
