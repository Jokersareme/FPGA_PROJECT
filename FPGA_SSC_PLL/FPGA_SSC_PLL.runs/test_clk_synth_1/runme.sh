...
HD_PWD='C:/Users/admin/Desktop/cygao/20260721/fpga_pll_mash111_dtc_ssc/fpga_pll_mash111_dtc_ssc/FPGA_SSC_PLL/FPGA_SSC_PLL.runs/test_clk_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_clk.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_clk.tcl
