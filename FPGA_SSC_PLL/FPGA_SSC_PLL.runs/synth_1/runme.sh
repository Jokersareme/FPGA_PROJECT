...
HD_PWD='C:/Users/admin/Desktop/cygao/20260715/FPGA_SSC_PLL/FPGA_SSC_PLL.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fpga_ssc_pll_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fpga_ssc_pll_top.tcl
