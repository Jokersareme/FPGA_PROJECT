...
HD_PWD='X:/fpga_pll_mash111_dtc_ssc/FPGA_SSC_PLL/FPGA_SSC_PLL.runs/ila_cal_top_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ila_cal_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ila_cal_top.tcl
