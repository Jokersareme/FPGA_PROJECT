...
HD_PWD='X:/fpga_pll_mash111_dtc_ssc/FPGA_SSC_PLL/FPGA_SSC_PLL.runs/vio_ssc_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vio_ssc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vio_ssc.tcl
