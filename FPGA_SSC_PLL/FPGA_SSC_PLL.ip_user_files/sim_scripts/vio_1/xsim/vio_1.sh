...
#
# Script generated by Vivado on Thu Jul 16 19:12:50 +0800 2026
...
#
# Usage        : vio_1.sh
#                vio_1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                vio_1.sh [-reset_run]
#                vio_1.sh [-reset_log]
#                vio_1.sh [-help]
#
...
# script info
echo -e "vio_1.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./vio_1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot vio_1 xil_defaultlib.vio_1 xil_defaultlib.glbl -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb vio_1.wdb xsim.dir libdpi.so)
...
Usage: vio_1.sh [-reset_log]\n\
Usage: vio_1.sh [-keep_index]\n\
