...
#
# Script generated by Vivado on Thu Jul 16 09:54:26 +0800 2026
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : mash_stage.sh
...
#
# Usage        : mash_stage.sh
#                mash_stage.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                mash_stage.sh [-reset_run]
#                mash_stage.sh [-reset_log]
#                mash_stage.sh [-help]
#
...
# script info
echo -e "mash_stage.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./mash_stage.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot mash_stage xil_defaultlib.mash_stage xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim mash_stage -key {Behavioral:sim_1:Functional:mash_stage} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mash_stage.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./mash_stage.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: mash_stage.sh [-help]\n\
Usage: mash_stage.sh [-step]\n\
Usage: mash_stage.sh [-lib_map_path]\n\
Usage: mash_stage.sh [-reset_run]\n\
Usage: mash_stage.sh [-reset_log]\n\
Usage: mash_stage.sh [-keep_index]\n\
Usage: mash_stage.sh [-noclean_files]\n\n\
