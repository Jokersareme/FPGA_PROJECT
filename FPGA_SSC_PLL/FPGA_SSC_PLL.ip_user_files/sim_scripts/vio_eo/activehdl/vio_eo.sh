...
#                script (type 'vio_eo.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/admin/Desktop/cygao/20260720/fpga_pll_mash111_dtc_ssc/FPGA_SSC_PLL/FPGA_SSC_PLL.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
