...
#                script (type 'ila_dualdiv.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/admin/Desktop/cygao/20260715/FPGA_SSC_PLL/FPGA_SSC_PLL.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
