...
#
# Script generated by Vivado on Tue Jul 21 19:48:08 +0800 2026
...
#
# Usage        : vio_cal.sh
#                vio_cal.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                vio_cal.sh [-reset_run]
#                vio_cal.sh [-reset_log]
#                vio_cal.sh [-help]
#
...
# script info
echo -e "vio_cal.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./vio_cal.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot vio_cal xil_defaultlib.vio_cal xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim vio_cal -key {Behavioral:sim_1:Functional:vio_cal} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb vio_cal.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./vio_cal.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: vio_cal.sh [-help]\n\
Usage: vio_cal.sh [-step]\n\
Usage: vio_cal.sh [-lib_map_path]\n\
Usage: vio_cal.sh [-reset_run]\n\
Usage: vio_cal.sh [-reset_log]\n\
Usage: vio_cal.sh [-keep_index]\n\
Usage: vio_cal.sh [-noclean_files]\n\n\
