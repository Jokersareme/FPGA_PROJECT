...
module clk_wiz_0 (
  ...
  input clk_in1;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 clock_CLKFB_IN CLKFB_IN" *)
  (* X_INTERFACE_MODE = "slave clock_CLKFB_IN" *)
  (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME clock_CLKFB_IN, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN , ASSOCIATED_BUSIF , ASSOCIATED_PORT , ASSOCIATED_RESET , INSERT_VIP 0" *)
  input clkfb_in;
  ...
  output clk_out1;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 clock_CLKFB_OUT CLKFB_OUT" *)
  (* X_INTERFACE_MODE = "master clock_CLKFB_OUT" *)
  (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME clock_CLKFB_OUT, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN , ASSOCIATED_BUSIF , ASSOCIATED_PORT , ASSOCIATED_RESET , INSERT_VIP 0" *)
  output clkfb_out;
